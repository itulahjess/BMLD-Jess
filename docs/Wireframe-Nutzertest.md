...
Nutzer 2: Vielleicht kann man nach dem "Du hast dich erfolgreich registriert" noch etwas wie "Jetzt kannst du dich einloggen" hinzufügen, um Verwirrung zu vermeiden, ansonsten gut.
Nutzer 3: Wie eine richtige Registrierung
...
### Home Bildschirm:
Nutzer 1: übersichtlich, noch kreativer gestalten
Nutzer 2: Kann noch etwas kreativer gestaltet werden, ansonsten gut
Nutzer 3: gut

### Profil:
Nutzer 1: gut
Nutzer 2: Man könnte noch zusätzlich Einstellungen hinzufügen, wie z.B. Sprachverwaltung, Benachrichtigungen, etc.
Nutzer 3: Anstelle von weiss, Profilbild Männchen oder eine Farbe

### Übersich der Abos:
Nutzer 1: informativ, übersichtlich
Nutzer 2: gut
